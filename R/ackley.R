...
#' 	Recommended variable values are: a = 20, b = 0.2 and c = 2p.
#' 	The function is usually evaluated on the hypercube xi <U+2208> [-32.768, 32.768], for all i = 1, ?, d, although it may also be restricted to a smaller domain.
#' @references \url{https://www.sfu.ca/~ssurjano/ackley.html}
